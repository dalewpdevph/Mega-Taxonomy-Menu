jQuery(document).ready(function($){
	...
	function optionsframework_add_file(event, selector) {
		...
		if ( optionsframework_upload ) {
			...
			optionsframework_upload.on( 'select', function() {
				...
				optionsframework_selector.find('.upload-button').unbind().addClass('remove-file').removeClass('upload-button').val(mtm_optionsframework_l10n.remove);
	...
	function optionsframework_remove_file(selector) {
		...
		selector.find('.remove-file').unbind().addClass('upload-button').removeClass('remove-file').val(mtm_optionsframework_l10n.upload);
