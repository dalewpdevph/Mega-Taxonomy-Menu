...
class Options_Framework_Media_Uploader {
	...
	public function init() {
		add_action( 'admin_enqueue_scripts', array( $this, 'mtm_optionsframework_media_scripts' ) );
	}
	...
	static function mtm_optionsframework_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
	 ...
	 */
	function mtm_optionsframework_media_scripts( $hook ) {
		...
		wp_localize_script( 'of-media-uploader', 'mtm_optionsframework_l10n', array(
