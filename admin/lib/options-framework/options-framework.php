 ...
 * Text Domain: mtm_optionsframework
...
function mtm_optionsframework_init() {
...
add_action( 'init', 'mtm_optionsframework_init', 20 );
...
if ( ! function_exists( 'mtm_get_option' ) ) :

function mtm_get_option( $name, $default = false ) {
	$config = get_option( 'mtm_optionsframework' );
